        ...
        <div className="max-w-7xl mx-auto px-5 py-4 flex items-center justify-between">
          <button onClick={() => scrollTo("home")} className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <div className="f-mad leading-none amber" style={{ fontSize: 16, letterSpacing: "0.05em" }}>PATRIOTAS</div>
              <div className="f-stencil olive" style={{ fontSize: 9, letterSpacing: "0.4em" }}>BRASIL · LE · MC</div>
            </div>
          </button>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 anim-fadeup">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-14 mb-10">
            ...
            <div className="flex-1 text-center">
              ...
              <div className="divider mb-5" style={{ maxWidth: 400 }} />
